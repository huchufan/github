...
from agent.core.types import SessionRecord, KnowledgeItem
...
def test_semantic_search_threshold_and_graph():
    ...
    a = KnowledgeItem(title='A', content='alpha content', category='cat', concepts=[], relationships=[{'target_id': 'B', 'type': 'rel', 'strength': 1.0}], source='src', tags=[], domain='d')
    b = KnowledgeItem(title='B', content='beta content', category='cat', concepts=[], relationships=[], source='src', tags=[], domain='d')
