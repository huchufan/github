...
def test_calc_avg_and_empty():
    ...
    # avg with values
    tr1 = TaskResult(
        task_id="t1", status="SUCCESS", result={}, duration=2.0, success=True
    )
    tr2 = TaskResult(
        task_id="t2", status="SUCCESS", result={}, duration=4.0, success=True
    )
...
def test_parallelism_efficiency_and_critical_path():
    ...
    r2 = TaskResult(
        task_id="t2", status="SUCCESS", result={}, duration=1.0, success=True
    )
...
def test_identify_bottleneck_and_retry_rate():
    ...
    tr = TaskResult(
        task_id="t1", status="SUCCESS", result={}, duration=35.0, success=True
    )
