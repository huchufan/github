...
from agent.core.types import ExecutionState, ExecutionPlan, SubTask, TaskResult, ExecutionMetrics, Anomaly
...
def test_monitor_execution_full_paths():
    ...
    tr1 = TaskResult(task_id='t1', status='SUCCESS', result={}, duration=10.0, success=True)
    tr2 = TaskResult(task_id='t2', status='FAIL', result={}, duration=5.0, success=False)
